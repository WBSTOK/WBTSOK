  ...
  document.querySelector('footer').innerHTML = `
    ...
    <div class="footer-bottom">
      ...
      <div class="social-icons">
        <a href="https://www.facebook.com/OklahomaTestStrips/" target="_blank" aria-label="Follow us on Facebook"><i class="fab fa-facebook-f"></i></a>
        <a href="https://www.instagram.com/wbtsok/" target="_blank" aria-label="Follow us on Instagram"><i class="fab fa-instagram"></i></a>
      </div>
    </div>
  `;
});